...
//         });
//         const embed = this.createEmbedBuilder(eventDetails)
//             .setTitle(`DDD Leaderboard for ${(<any>this.context!).guild!.name}`)
...
//         const eventID = this.getEventID(eventDetails);
//         const embed = this.createEmbedBuilder(eventDetails)
//             .setTitle(`DDD Settings for ${(<any>this.context!).guild!.name}`)
//             .setDescription([
...
//         const embed = this.createEmbedBuilder(eventDetails)
//             .setDescription([
//                 `${(<any>this.context!).member} Thanks for playing! Please check your date, time and timezone details below. If they are incorrect you can join again before the season starts!`,
//                 '',
