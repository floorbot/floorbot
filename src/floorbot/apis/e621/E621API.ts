...
export class E621API extends API<E621APIRequestOptions> {
    ...
    protected override fetch(request: E621APIRequestOptions & { type: 'json', endpoint: 'tags'; }): Promise<E621APITag[]>;
    protected override fetch(request: E621APIRequestOptions & { type: 'json', endpoint: 'posts/random'; }): Promise<{ post: E621APIPost; } | E621APIError>;
    protected override fetch(request: E621APIRequestOptions & { type: 'json', endpoint: 'tags/autocomplete'; }): Promise<E621APIAutocomplete[] | E621APIError>;
    protected override async fetch(request: E621APIRequestOptions): Promise<unknown> {
        return super.fetch(request);
    }

    public async tags(tags: string): Promise<E621APITag[]> {
    ...
    public async random(tags: string | null): Promise<E621APIPost | E621APIError> {
        const res = await this.fetch({ endpoint: 'posts/random', type: 'json', params: [['tags', tags ?? '']] });
