...
export class MarkovStateTable extends MariaDBTable<MarkovStateRow, Pick<MarkovStateRow, 'channel_id' | 'message_id' | 'message_part'>> {
    ...
    public async selectRandomState(data: SelectionRow<MarkovStateRow, 'channel_id'>, { limit, order }: { limit?: number; order?: SelectOrder<MarkovStateRow>; } = {}): Promise<MarkovStateRow | null> {
