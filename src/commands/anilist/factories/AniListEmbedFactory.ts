...
export class AniListEmbedFactory {
    ...
    public static getCharacterNodeEmbed(handler: AniListHandler<AniListCustomData>, context: HandlerContext, character: Character, media: Media, page: number): HandlerEmbed {
    ...
    public static getCharacterEmbed(handler: AniListHandler<AniListCustomData>, context: HandlerContext, character: Character): HandlerEmbed {
